...
export interface BreakdownInspectorModel {
...
/**
 * Derives the inspector's read-only view of one breakdown from its management payload.
 *
 * The breakdown analogue of `screenplay-inspector-model.ts`, and deliberately cheaper: a
 ...
 */
export function buildBreakdownInspectorModel(management: ManagedProject): BreakdownInspectorModel {
