...
describe('screenplay statistics model', () => {
  ...
  it('allocates page equivalents by rendered lines and labels structural heuristics explicitly', () => {
    ...
    expect(
      ...
      { estimatedPages: 0.05, firstPage: 1, lastPage: 1 },
      { estimatedPages: 0.08, firstPage: 1, lastPage: 2 },
    ]);
    expect(model.pacing).toMatchObject({
      averageScenePages: 0.07,
      medianScenePages: 0.07,
      minimumScenePages: 0.05,
      maximumScenePages: 0.08,
      shortSceneCount: 2,
