...
CREATE TABLE "screenplay_comment_threads" (
    "id" UUID NOT NULL,
...
CREATE INDEX "screenplay_comment_threads_screenplay_id_status_idx"
  ON "screenplay_comment_threads"("screenplay_id", "status");

CREATE TABLE "screenplay_comments" (
    "id" UUID NOT NULL,
...
CREATE INDEX "screenplay_comments_thread_id_created_at_idx"
  ON "screenplay_comments"("thread_id", "created_at");

ALTER TABLE "screenplay_comments"
  ADD CONSTRAINT "screenplay_comments_thread_id_fkey"
